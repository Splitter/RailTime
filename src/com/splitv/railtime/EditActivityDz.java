...
public class EditActivityDz extends SherlockFragmentActivity {
	...
	public static class TimePickerFragment extends SherlockDialogFragment
		...
		public Dialog onCreateDialog(Bundle savedInstanceState) {
			...
			String time = ((EditActivityDz)getActivity()).getFieldText();
			...
			String title = "";
			if(((EditActivityDz)getActivity()).curOpt=="startActivity"){
		...
		public void onTimeSet(TimePicker view, int hour, int minute) {
			...
			((EditActivityDz)getActivity()).updateTime(hour,minute);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
                ...
                builder.setPositiveButton(R.string.yes,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {                            	
                            	//Setup DB helper
                        		helper = new railDBHelper( EditActivityDz.this);
                        		//get db instance
                        		...
                        		try {
                        			db.execSQL(query);
                        			//notify on success
                        			Toast.makeText( EditActivityDz.this, R.string.delete_shift_success, Toast.LENGTH_SHORT).show();
                        			dialog.dismiss();
                        			 EditActivityDz.this.setResult(RESULT_OK, null);
                            		finish();
                        		} catch (SQLException e) {
                        			e.printStackTrace();
                        			//notify on failure
                        			Toast.makeText( EditActivityDz.this, R.string.delete_shift_failed, Toast.LENGTH_SHORT).show();
                        			dialog.dismiss();
                        		}
                            }
                        });
	    ...
	    miPrefs.setOnMenuItemClickListener(new OnMenuItemClickListener() {	    	 
            ...
            public boolean onMenuItemClick(MenuItem item) {
        		...
        		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(EditActivityDz.this);
        		...
        		//Setup DB helper
        		railDBHelper helper = new railDBHelper(EditActivityDz.this);
        		//get db instance
        		SQLiteDatabase db = helper.getWritableDatabase();     
    			...
    			if(db.update(railDBHelper.activityTable, args, strFilter, null)>0){
    				Toast.makeText(EditActivityDz.this, R.string.saved_rail_data, Toast.LENGTH_SHORT).show();
            			
        		}
        		else{
        			Toast.makeText(EditActivityDz.this, R.string.saved_rail_data_failed, Toast.LENGTH_SHORT).show();
