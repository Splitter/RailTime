...
public class AddActivityRail extends SherlockFragmentActivity {
	...
	public static class TimePickerFragment extends SherlockDialogFragment
		...
		public Dialog onCreateDialog(Bundle savedInstanceState) {
			...
			String time = ((AddActivityRail)getActivity()).getFieldText();
			...
			String title = "";
			if(((AddActivityRail)getActivity()).curOpt=="startActivity"){
		...
		public void onTimeSet(TimePicker view, int hour, int minute) {
			...
			((AddActivityRail)getActivity()).updateTime(hour,minute);
	    ...
	    miPrefs.setOnMenuItemClickListener(new OnMenuItemClickListener() {	    	 
            ...
            public boolean onMenuItemClick(MenuItem item) { 
            	...
            	if(editTextEmpty(field)){
            		Toast.makeText(AddActivityRail.this, R.string.add_rail_empty_fields, Toast.LENGTH_SHORT).show();
        			return true;
            	}        		
        		...
        		String type = getString(R.string.shift_activity_rail);
        		
        		String timestamp = String.valueOf(Calendar.getInstance().getTimeInMillis());
        		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(AddActivityRail.this);
        		...
        		//Setup DB helper
        		railDBHelper helper = new railDBHelper(AddActivityRail.this);
        		//get db instance
        		...
        		try {
        			...
        			db.execSQL(query, new String[]{railStart,railEnd,_shiftId,activityHours,notes,timestamp,type,railNumber,railUnits,railLoaders});
        			//notify on success
        			Toast.makeText(AddActivityRail.this, R.string.saved_rail_data, Toast.LENGTH_SHORT).show();
        			
        		} catch (SQLException e) {

        			e.printStackTrace();
        			//notify on failure
        			Toast.makeText(AddActivityRail.this, R.string.saved_rail_data_failed, Toast.LENGTH_SHORT).show();
        			
        		}    

        		//exit activity
        		AddActivityRail.this.setResult(RESULT_OK, null);
        		finish();  
				return true;
            }
